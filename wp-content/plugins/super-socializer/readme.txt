...
= 7.13.58 [24 August 2023] =
* [Bugfix] Updating the plugin to the previous version was breaking the website in a few cases

= 7.13.57 [24 August 2023] =
...
* [New] Added Google News share icon in the social share networks
* [New] Added RSS Feed icon in the social share networks
* [New] Added [TheChamp-Social-Follow] shortcode 
...
* [Bugfix] Pocket social share icon was not working
* [Bugfix] Pocket social share icon was appearing broken in AMP
* [Bugfix] Linkedin social login stopped working for the new apps because of the recent changes introduced by Linkedin
* [Improvement] Twitter login is now X login
* [Improvement] Social share and Social follow links now have "aria-label" attribute making these accessible for screen-readers
* [Improvement] Needed to scroll a lot at the configuration page to see the Save button
* [Improvement] Minor improvements

= 7.13.56 [21 July 2023] =
* [Bugfix] Yandex social login was not pulling user's email with other profile data in some cases
* [Bugfix] hash in the redirect_url parameter in the [TheChamp-Login] shortcode was being omitted on redirection after social login

= 7.13.55 [12 July 2023] =
* [Bugfix] Line social login was not pulling users' email with other profile data
* [Bugfix] "Share" text was not being displayed with the total share count when "Load all Javascript files in single file" option in the General Options section was unchecked
* [Improvement] AJAX requests used throughout the plugin now use nonce verification making these more secure
* [Improvement] Admin UI improvement

= 7.13.54 [26 June 2023] =
* [Security] URL passed in the [TheChamp-Counter] and [TheChamp-Sharing] shortcodes is now being escaped before being inserted into the HTML
* [Bugfix] Discord social login was not pulling users' social avatar with other profile data
* [Improvement] Improved social login functionality

= 7.13.53 [7 June 2023] =
* [Security] Now only Admin can clear share counts cache and bit.ly cache 
* [Security] Fixed a Reflected Cross-Site Scripting vulnerability in the [TheChamp-FB-Comments] shortcode
* [Improvement] Updated the Facebook JS SDK being used throughout the plugin to the latest version 17.0
...
* [Improvement] Yandex login is now redirecting to the login screen in the Russian language instead of the English version

= 7.13.52 [25 May 2023] =
* [Security] Fixed a Reflected Cross-Site Scripting vulnerability

= 7.13.51 [16 May 2023] =
* [Bugfix] Using shortcode with the <a href="https://www.heateor.com/social-shares-tracker" target="_blank">Social Shares Tracker</a> add-on was causing trouble with the share counts

= 7.13.50 [15 May 2023] =
* [Bugfix] Facebook Messenger social share icon didn't have the title attribute which was not letting the <a href="https://www.heateor.com/social-shares-tracker" target="_blank">Social Shares Tracker</a> add-on track shares for the same

= 7.13.49 [15 May 2023] =
* [Bugfix] Vkontakte, Mix and MeWe social share icons were appearing distorted with the <a href="https://www.heateor.com/social-shares-tracker" target="_blank">Social Shares Tracker</a> add-on active and with any of the inner-top or inner-bottom counter position active

= 7.13.48 [24 April 2023] =
* [New] Compatible with the <a href="https://wordpress.org/plugins/new-user-approve/" target="_blank">New User Approve</a> plugin
* [Bugfix] Mixi share was sharing incorrect URL
* [Improvement] Improved Youtube login
* [Improvement] Twitter login is now saving URL in the user's Twitter profile in the Website field of WordPress instead of the user's Twitter profile link
* [Improvement] Supports Oauth 2.0 for Twitter login
* [Improvement] Improved Parler logo
* [Improvement] Updated the Facebook JS SDK being used throughout the plugin to the latest version 16.0

= 7.13.47 [5 March 2023] =
* [Improvement] Improved Google login icon

= 7.13.46 [4 February 2023] =
* [Bugfix] Facebook Messenger share was not working
* [Bugfix] Parler logo in the Share icon was mis-aligned when share-counter position was inner-top or inner-bottom
* [Bugfix] Added href attribute in the anchor tags for Facebook Messenger, Print, Email, Pinterest and Copy Link share icons to fix the "Links are not crawlable" warning in the Google Search Console
* [Bugfix] Fixed the logo color of the Pocket share icon in the More popup

= 7.13.45 [28 December 2022] =
* [Security] Fixed Cross-Site Scripting vulnerability exploit in the "type" attribute of [TheChamp-Counter] shortcode
* [New] Added an option to generate usernames from the email address for the new users registering via Social Login

= 7.13.44 [23 December 2022] =
* [Security] Fixed Cross-Site Scripting vulnerability exploit in the shortcodes
* [Improvement] Added support for "astra_checkout_login_field_before" action for Social Login buttons to appear at the WooCommerce checkout page when using the relevant option in the plugin configuration when using Astra theme
* [Improvement] Improved Print icon
* [Improvement] Total shares are now appearing with the White background and improved font-size in the floating share bar being displayed in the mobile devices
* [Improvement] Minor improvements
...
= 7.13.36 [21 July 2022] =
* [New] Added Odnoklassniki in Social Login networks
* [New] Added Yandex in Social Login networks
* [New] Added Mastodon in Social Share networks
* [Improvement] Linkedin social avatars are now being loaded from your website instead of the Linkedin server
* [Improvement] Improved Vkontakte logo
* [Improvement] Improved Gettr logo
* [Improvement] Updated the Facebook JS SDK being used throughout the plugin to the latest version 14.0
* [Improvement] Minor CSS improvements for the social share buttons
