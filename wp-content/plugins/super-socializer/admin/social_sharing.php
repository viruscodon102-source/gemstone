			...
			<div class="menu_containt_div" id="tabs-2">
				...
				<div class="stuffbox">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="form-table editcomment menu_content_table">
						...
						$googleNewsUrl = '';
						if(isset($theChampSharingOptions['google_news_url']) && $theChampSharingOptions['google_news_url']){
							$googleNewsUrl = $theChampSharingOptions['google_news_url'];
						}elseif(isset($theChampSharingOptions['vertical_google_news_url'])){
							$googleNewsUrl = $theChampSharingOptions['vertical_google_news_url'];
						}
						$rutubeUsername = '';
						if(isset($theChampSharingOptions['rutube_url'])){
							$rutubeUsername = $theChampSharingOptions['rutube_url'];
						}elseif(isset($theChampSharingOptions['vertical_rutube_url'])){
							$rutubeUsername = $theChampSharingOptions['vertical_rutube_url'];
						}
						$instagramUsername = '';
						...
						<tbody id="the_champ_youtube_options" <?php echo !isset($theChampSharingOptions['horizontal_re_providers']) || !in_array('youtube', $theChampSharingOptions['horizontal_re_providers']) ? 'style = "display: none"' : '';?> >
							...
							<tr class="the_champ_help_content" id="the_champ_youtube_username_help_cont">
								<td colspan="2">
								<div>
								<?php _e('URL you want to redirect users to, on clicking the Youtube icon', 'super-socializer') ?>
								</div>
								</td>
							</tr>
						</tbody>
						<tbody id="the_champ_rutube_options" <?php echo !isset($theChampSharingOptions['horizontal_re_providers']) || !in_array('rutube', $theChampSharingOptions['horizontal_re_providers']) ? 'style = "display: none"' : '';?> >
							<tr>
								<th>
								<label for="the_champ_rutube_url"><?php _e("Rutube URL", 'super-socializer'); ?></label><img id="the_champ_rutube_url_help" class="the_champ_help_bubble" src="<?php echo plugins_url('../images/info.png', __FILE__) ?>" />
								</th>
								<td>
								<input id="the_champ_rutube_url" name="the_champ_sharing[rutube_url]" type="text" value="<?php echo esc_attr($rutubeUsername) ?>" />
								</td>
							</tr>
							
							<tr class="the_champ_help_content" id="the_champ_rutube_url_help_cont">
								<td colspan="2">
								<div>
								<?php _e('URL you want to redirect users to, on clicking the Rutube icon', 'super-socializer') ?>
								</div>
								</td>
							</tr>
						</tbody>
						<tbody id="the_champ_google_news_options" <?php echo ! in_array('Google_News', $theChampSharingOptions['horizontal_re_providers'] ) ? 'style="display:none"' : '';?>>
							<tr>
								<th>
								<label for="the_champ_google_news_url"><?php _e("Google News URL", 'super-socializer'); ?></label>
								<img id="the_champ_google_news_url_help" class="the_champ_help_bubble" src="<?php echo plugins_url('../images/info.png', __FILE__ ) ?>" />
								</th>
								<td>
								<input id="the_champ_google_news_url" name="the_champ_sharing[google_news_url]" type="text" value="<?php echo esc_attr( $googleNewsUrl ) ?>" />
								</td>
							</tr>
							<tr class="the_champ_help_content" id="the_champ_google_news_url_help_cont">
								<td colspan="2">
								<div>
								<?php _e('URL of the Google News page where you want the website-visitors to get redirected on click of the icon', 'super-socializer') ?>
								</div>
								</td>
							</tr>
						</tbody>
						...
						<tr>
							<td colspan="2">
							<?php _e('(Logo color of the icons here will always be white, even if you have saved any other Logo Color in the Theme Selection section. However, at the front-end of the website, icons will be of the color that you have saved in the Theme Selection section.)', 'super-socializer');
							?>
							<script>
							<?php
			...
			<div class="menu_containt_div" id="tabs-3">
				...
				<div class="the_champ_left_column">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="form-table editcomment menu_content_table">
						...
						<tbody id="the_champ_vertical_rutube_options" <?php echo !isset($theChampSharingOptions['vertical_re_providers']) || !in_array('rutube', $theChampSharingOptions['vertical_re_providers']) ? 'style = "display: none"' : '';?> >
							<tr>
								<th>
								<label for="the_champ_vertical_rutube_url"><?php _e("Rutube URL", 'super-socializer'); ?></label><img id="the_champ_vertical_rutube_url_help" class="the_champ_help_bubble" src="<?php echo plugins_url('../images/info.png', __FILE__) ?>" />
								</th>
								<td>
								<input id="the_champ_vertical_rutube_url" name="the_champ_sharing[vertical_rutube_url]" type="text" value="<?php echo esc_attr($rutubeUsername) ?>" />
								</td>
							</tr>
							
							<tr class="the_champ_help_content" id="the_champ_vertical_rutube_url_help_cont">
								<td colspan="2">
								<div>
								<?php _e('URL you want to redirect users to, on clicking the Rutube icon', 'super-socializer') ?>
								</div>
						...
						<tbody id="the_champ_vertical_google_news_options" <?php echo ! in_array('Google_News', $theChampSharingOptions['vertical_re_providers'] ) ? 'style="display:none"' : '';?>>
							<tr>
								<th>
								<label for="the_champ_vertical_google_news_url"><?php _e("Google News URL", 'super-socializer'); ?></label>
								<img id="the_champ_vertical_google_news_url_help" class="the_champ_help_bubble" src="<?php echo plugins_url('../images/info.png', __FILE__ ) ?>" />
								</th>
								<td>
								<input id="the_champ_vertical_google_news_url" name="the_champ_sharing[vertical_google_news_url]" type="text" value="<?php echo esc_attr( $googleNewsUrl ) ?>" />
								</td>
							</tr>
							<tr class="the_champ_help_content" id="the_champ_vertical_google_news_url_help_cont">
								<td colspan="2">
								<div>
								<?php _e('URL of the Google News page where you want the website-visitors to get redirected on click of the icon', 'super-socializer') ?>
								</div>
			...
			<div class="menu_containt_div" id="tabs-6">
				...
				<div class="stuffbox">
					...
					<div class="inside" style="padding-left:7px">
						<p><a style="text-decoration:none" href="https://support.heateor.com/social-sharing-shortcode-and-widget/" target="_blank"><?php _e('Social Share Shortcode & Widget', 'super-socializer') ?></a></p>
						<p><a style="text-decoration:none" href="https://support.heateor.com/social-follow-buttons-shortcode-and-widget/" target="_blank"><?php _e('Social Media Follow Shortcode & Widget', 'super-socializer') ?></a></p>
					</div>
				</div>
				</div>
				<?php include 'help.php'; ?>
